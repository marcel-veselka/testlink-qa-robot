...
${REMOTE_URL} =  http://blablablabla4:vKrBzZzpUjEZuSyWn844@hub.browserstack.com/wd/hub
...
test
    ...
    open browser  http://${stripped}/testlink-code  remote_url=${REMOTE_URL}  desired_capabilities=${DESIRED_CAPABILITIES}
